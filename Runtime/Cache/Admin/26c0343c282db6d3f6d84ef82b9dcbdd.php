...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?php echo U('Admin/Resource/serachrearticle');?>" method="post">
	<div class="searchBar">
...
<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<?php echo U('Admin/Resource/addarticle');?>" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="__GROUP__/ResourceAct/delarticle/id/{sid_user}" target="ajaxTodo" title="删除" warn="你确定要删除吗？"><span>删除</span></a></li>
			<li><a class="edit" href="__URL__/editarticle/id/{sid_user}" target="navTab" warn="你确定要修改吗？"><span>修改</span></a></li>
...
<table class="list" width="100%" layoutH="116">
      ...
      <tbody>
	  <?php if(is_array($articledata)): $i = 0; $__LIST__ = $articledata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_user" rel="<?php echo ($vo['id']); ?>">
